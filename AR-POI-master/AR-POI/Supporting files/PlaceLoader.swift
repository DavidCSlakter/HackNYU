...
struct PlaceLoader {
    ...
    func requestPOIsWithGoogleSearch(location: CLLocation, completion: @escaping (_ items:[[String: Any]]?, _ errorMsg:String?) -> Void) {
        
        let gMapsUrl = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?"
        let radiusMeters = 100
        let language = "en"
        let googleApiKey = "AIzaSyDIJmmNemDTxZ8uY_3YxlUhJnw3I4tRKM8"
        let types = ["cafe", "restaurant", "convenience_store", "museum", "bar", "bakery", "atm"]
